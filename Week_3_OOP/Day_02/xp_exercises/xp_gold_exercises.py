...
class BankAccount :
    ...
    def deposit(self, money) :
        ...
        try :
            ...
            print("You need to provide a positive integer as an amount of money you want to deposit on your account.")
    ...
    def withdraw(self, money) :
        ...
        try :
            ...
            print("You need to provide a positive integer as an amount of money you want to withdraw from your account.")
...
class MinimumBalanceAccount(BankAccount) :
    def __init__(self, balance, username, password, minimum_balance = 0) :
        BankAccount.__init__(self, username, password, authenticated = False)
        self.balance = balance
    ...
    def withdraw(self, money) :
        self.money = money
        try :
            if BankAccount.authenticate() == True :
                try :
                    if self.money > 0 :
                        try :
...
my_acc = MinimumBalanceAccount(1000, 50)
