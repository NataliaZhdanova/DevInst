...
// Answer: here destructuring happens
...
const newArr = arr.map(doubleID);
  
function doubleID(item) {
...
// Answer: a new object of Person class is instantiated
...
// Answer: #2 will successfully extend the Dog class
...
// Inside the class, add a method called sound(). This method takes a parameter: the sound the animal makes, 
...
const farmerCow = new Mammal("Lucy", "cow", "black");
